...
export const KIND_EXAMPLE_CONFIG = {
  ...
  image: {
    ...
    extraFields: [
      ...
      { key: "size", label: "Size", type: "select", default: "auto", options: ["auto", "1024x1024", "1024x768", "768x1024", "1K", "2K", "3K", "4K", "1024x1536", "1536x1024", "1024x1792", "1792x1024"] },
      { key: "ratio", label: "Ratio", type: "select", default: "", options: ["", "1:1", "16:9", "9:16", "4:3", "3:4", "3:2", "2:3", "21:9"] },
      ...
      { key: "negative_prompt", label: "Negative Prompt", type: "text", default: "", placeholder: "blurry, low quality, distorted" },
      { key: "guidance", label: "Guidance Scale", type: "number", default: 7.5, min: 1, max: 20 },
      { key: "strength", label: "Strength (Img2Img)", type: "number", default: 0.75, min: 0.05, max: 1 },
      { key: "num_steps", label: "Steps", type: "number", default: 20, min: 1, max: 50 },
      { key: "seed", label: "Seed", type: "number", default: "", placeholder: "Random" },
    ],
  },
  imageToText: {
