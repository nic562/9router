...
export default function MediaProviderDetailPage() {
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      {/* Provider Info — config-driven, supports searchConfig, fetchConfig, ttsConfig, embeddingConfig, systemoneConfig, imageConfig, videoConfig, searchViaChat */}
      {!isCustom && (provider.searchConfig || provider.fetchConfig || provider.ttsConfig || provider.sttConfig || provider.embeddingConfig || provider.systemoneConfig || provider.imageConfig || provider.videoConfig || provider.searchViaChat) && (
        <ProviderInfoCard
          config={
