...
import JsonViewer from "@/shared/components/JsonTreeView";
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <CollapsibleSection title="1. Client Request (Input)" defaultOpen={true} icon="input">
                <JsonViewer data={selectedDetail.request} title="Client Request" maxHeight="500px" />
              </CollapsibleSection>

              {selectedDetail.providerRequest && (
                <CollapsibleSection title="2. Provider Request (Translated)" defaultOpen={true} icon="translate">
                  <JsonViewer data={selectedDetail.providerRequest} title="Provider Request" maxHeight="500px" />
                </CollapsibleSection>
              )}

              {selectedDetail.providerResponse && (
                <CollapsibleSection title="3. Provider Response (Raw)" icon="data_object">
                  <JsonViewer data={selectedDetail.providerResponse} title="Provider Response" maxHeight="500px" />
                </CollapsibleSection>
              )}
